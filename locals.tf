...
locals {
  ...
  networking = {
    ...
    private_dns_resolver_forwarding_dynamic_rules           = try(var.networking.private_dns_resolver_forwarding_dynamic_rules, {})
    ...
    routing_intents                                         = try(var.networking.routing_intents, {})
  ...
  shared_services = {
    ...
    monitor_data_collection_endpoints         = try(var.shared_services.monitor_data_collection_endpoints, {})
    monitor_metric_alert                      = try(var.shared_services.monitor_metric_alert, {})
    monitor_private_link_scoped_services      = try(var.shared_services.monitor_private_link_scoped_services, {})
